...
<style lang="scss">
.list_card .v-list-item {
  font-weight: 100;
  min-height: 36px;
  padding: 0 !important;
}
.list_card .v-list-item span {
...
.deadline {
  ...
  align-items: center;
  font: 100 12px Circular, Arial, Helvetica, sans-serif;
  color: #fff;
  -webkit-box-pack: center;
  justify-content: center;
  letter-spacing: 0em;
  background-image: linear-gradient(141deg, #fc734d 0%, #f9872c 100%);
